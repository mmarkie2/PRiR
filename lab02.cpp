...
void kodWatku()
{
 for (int i=0;i<10;++i) 
 { 
   cout<<"watek: "<<this_thread::get_id()<<" mówi cześć, i="<<i<<endl; this_thread::sleep_for(chrono::milliseconds(100)); 
 }
}
void listing1()
...
cout << "Sprzętowa współbieżność: " << thread::hardware_concurrency() << endl; cout<< "ID wątku: " << watek.get_id ()<<endl; 
